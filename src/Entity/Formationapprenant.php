 ...
 * Formationapprenant
 *
 * @ORM\Table(name="formationapprenant", indexes={@ORM\Index(name="formatonAPp", columns={"id_apprenant", "id_formation"}), @ORM\Index(name="pk_forma_app_form", columns={"id_formation"}), @ORM\Index(name="IDX_2DB954BF44DEFA09", columns={"id_apprenant"})})
 * @ORM\Entity
 */
